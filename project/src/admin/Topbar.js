                ...
                <ul className="nav navbar-nav navbar-left">
                    <li>
                        <div className="navbar-header">
                            ...
                            <a className="navbar-brand" href="/Dashboard2"><img src="https://thememakker.com/templates/oreo/hospital/html/assets/images/logo.svg" width={30} alt="Oreo" /><span className="m-l-10">Oreo</span></a>
                        </div>
                    </li>
                    ...
                    <li className="float-right">
                        ...
                        {/* <a href="Register" className="js-right-sidebar" data-close="true"><i className="zmdi zmdi-settings zmdi-hc-spin" /></a> */}
                    </li>
                </ul>
            </nav>
