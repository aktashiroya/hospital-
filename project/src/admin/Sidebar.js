              ...
              <ul className="list">
                ...
                <li>
                  ...
                  <ul className="ml-menu">
                    <li>
                      <a href="/All_Appointment">All Appointment</a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="ml-menu">
                    <li>
                      <a href="/All_doctor">All Doctors</a>
                    </li>
                    <li>
                      <a href="/Add_doctor">Add Doctor</a>
                    </li>
                    <li>
                      <a href="/Doctor_pro">Doctor Profile</a>
                    </li>
                    <li>
                      <a href="events.html">Doctor Schedule</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="ml-menu">
                    ...
                    <li>
                      <a href="patient-invoice.html">Invoice</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="ml-menu">
                    ...
                    <li>
                      <a href="add-payments.html">Add Payment</a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="ml-menu">
                    <li>
                      <a href="add-departments.html">Add</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="javascript:void(0);">Pulmonology</a>
                    </li>
                    <li>
                      <a href="javascript:void(0);">Gynecology</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="javascript:void(0);">Gastrology</a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="ml-menu">
                    <li>
                      <a href="file-dashboard.html">All File</a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="ml-menu">
                    <li>
                      <a href="widgets-app.html">Apps Widgetse</a>
                    </li>
                    <li>
                      <a href="widgets-data.html">Data Widgetse</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="ml-menu">
                    ...
                    <li>
                      <a href="https://thememakker.com/templates/oreo/hospital/html/rtl/index.html">
                        RTL Support
                      </a>
                    </li>
                    <li>
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      ...
                      <div className="progress m-b-20">
                        ...
                        >
                          {" "}
                          <span className="sr-only">56% Complete</span>{" "}
                        </div>
                      </div>
                    </li>
                  </ul>
          ...
          <div className="tab-pane slideRight active" id="setting">
            <div className="slim_scroll">
              ...
              <div className="card theme-light-dark">
                ...
                <button className="m_img_btn btn btn-primary btn-round btn-block">
                  Sidebar Image
                </button>
              </div>
              <div className="card">
