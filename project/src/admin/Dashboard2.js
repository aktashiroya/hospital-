...
export default function Dashborad2() {
  return (
    <>
            ...
            <div className="row clearfix">
              <div className="col-lg-4 col-md-6">
                <div className="card">
                  <div className="body">
                    <h3
                      className="number count-to m-b-0"
                      data-from={0}
                      data-to={1600}
                      data-speed={2500}
                      data-fresh-interval={700}
                    >
                      1600 <i className="zmdi zmdi-trending-up float-right" />
                    </h3>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card">
                  <div className="body">
                    ...
                    >
                      3218 <i className="zmdi zmdi-trending-up float-right" />
                    </h3>
                ...
                <div className="card">
                  <div className="body">
                    <h3
                      ...
                      data-fresh-interval={1000}
                    >
                      284 <i className="zmdi zmdi-trending-up float-right" />
                    </h3>
                    <p className="text-muted">
                      Well Smiley Faces <i className="zmdi zmdi-mood" />
                    </p>
                    <div className="progress">
                      <div
            ...
            <div className="row clearfix">
                          ...
                          <div className="body">
                            <div className="row text-center">
                              ...
                              <div className="col-sm-3 col-6">
                                ...
                                <p className="text-muted margin-0">
                                  This Week's
                                </p>
                              </div>
                              <div className="col-sm-3 col-6">
                          ...
                          <table className="table m-b-0 table-hover">
                            ...
                            <tbody>
                              <tr>
                                <td>Hospital Name</td>
                                <td>
                                  Porterfield 508 Virginia Street Chicago, IL
                                  60653
                                </td>
                                <td>$2,325</td>
                                <td>
                              ...
                              <tr>
                                <td>Hospital Name</td>
                                <td>
                                  1516 Holt Street West Palm Beach, FL 33401
                                </td>
                                <td>$2,325</td>
                                <td>
                                  <i className="zmdi zmdi-star col-amber" />
              ...
              <div className="col-lg-4 col-md-12">
                <div className="card">
                  <div className="body">
                    <div
                      className="sparkline m-b-10"
                      data-type="bar"
                      data-width="97%"
                      data-height="38px"
                      data-bar-width={2}
                      data-bar-spacing={6}
                      data-bar-color="#555555"
                    >
                      2,8,5,3,1,7,9,5,6,4,2,3,1,2,8,5,3,1,7,9,5,6,4,2,3,1
                    </div>
                      ...
                      <table className="table table-striped m-b-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              215
                              <i className="zmdi zmdi-trending-up m-l-10" />
                            </td>
                          </tr>
                          <tr>
                            <td>Los Angeles</td>
                          ...
                          <tr>
                            ...
                            <td>
                              408
                              <i className="zmdi zmdi-trending-down m-l-10" />
                            </td>
                          </tr>
                          <tr>
                            <td>Houston</td>
            ...
            <div className="row clearfix">
              <div className="col-lg-4 col-md-12">
                <div className="card">
                  <div className="header">
                    <h2>
                      <strong>Heart</strong> Surgeries{" "}
                      <small>18% High then last month</small>
                    </h2>
                  </div>
                  <div className="body">
                    <div
                      ...
                      data-spot-color="rgb(96, 125, 139, 0.7)"
                      data-offset={90}
                      data-width="100%"
                      data-height="50px"
                      data-line-width={1}
                      data-line-color="rgb(96, 125, 139, 0.7)"
                      data-fill-color="rgba(96, 125, 139, 0.3)"
                    >
                      {" "}
              ...
              <div className="col-lg-4 col-md-12">
                <div className="card">
                  <div className="header">
                    <h2>
                      <strong>Medical</strong> Treatment{" "}
                      <small>18% High then last month</small>
                    </h2>
                  </div>
                  <div className="body">
                    <div
                      ...
                      data-spot-color="rgb(120, 184, 62, 0.7)"
                      data-offset={90}
                      data-width="100%"
                      data-height="50px"
                      data-line-width={1}
                      data-line-color="rgb(120, 184, 62, 0.7)"
                      data-fill-color="rgba(120, 184, 62, 0.3)"
                    >
                      {" "}
                      6,4,7,6,9,3,3,5,7,4,2,3,7,6{" "}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card">
                  ...
                  <div className="body">
                    <div
                      ...
                      data-bar-width={4}
                      data-bar-spacing={10}
                      data-bar-color="#00ced1"
                    >
                      2,8,5,3,1,7,9,5,6,4,2,3,1
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row clearfix">
              <div className="col-lg-4 col-md-12">
                <div className="card tasks_report">
                  ...
                  <div className="body text-center">
                    ...
                    <div
                      className="sparkline m-t-20"
                      data-type="bar"
                      data-width="97%"
                      data-height="28px"
                      data-bar-width={2}
                      data-bar-spacing={8}
                      data-bar-color="#212121"
                    >
                      3,2,6,5,9,8,7,8,4,5,1,2,9,5,1,3,5,7,4,6
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-lg-8 col-md-12">
                <div className="card patient_list">
                  <div className="header">
                    <h2>
                      <strong>New</strong> Patient List
                    </h2>
                    <ul className="header-dropdown">
                      <li className="dropdown">
                        {" "}
                      ...
                      <table className="table table-striped m-b-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <span className="badge badge-danger">Fever</span>{" "}
                            </td>
                          </tr>
                          <tr>
                            <td>2</td>
                            ...
                            <td>
                              <span className="badge badge-info">Cancer</span>{" "}
                            </td>
                          </tr>
                          <tr>
                            <td>3</td>
                            ...
                            <td>
                              <span className="badge badge-warning">Lakva</span>{" "}
                            </td>
                          </tr>
                          <tr>
                            <td>4</td>
