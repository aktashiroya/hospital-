                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        <div className="body text-center">
                                                            <div className="profile-image"> <img src={`http://localhost/hospital/img/${i.img}`} alt /> </div>
                                                            <div>
                                                                <h4 className="m-b-0"><strong>{i.fname}</strong>{i.lname}</h4>
                                                                <span className="job_post">{i.speciality}</span>
