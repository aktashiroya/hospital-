...
export default function Dashboard() {
    ...
    function submit(e) {
        ...
        axios.post('http://localhost/hospital/Addapoin.php', blogData)
    ...
    useEffect(() => {
        axios.get('http://localhost/hospital/All_doctor.php')
            .then(function (response) {
                console.log(response)
            ...
            <div className="wrapper">
                ...
                <div className="main_header">
                    ...
                    <div id="navbar" data-aos="fade-down">
                        <nav className="navbar auto-margin navbar-expand-lg navbar-light bg-light">
                            ...
                            <div className="collapse navbar-collapse" id="navbarMenu">
                                <ul className="navbar-nav mr-auto">
                                    ...
                                    <li className="nav-item d-md-none d-lg-none d-xl-none"><a className="nav-link" href="/login">Sign in</a></li>
                                    <li className="nav-item d-md-none d-lg-none d-xl-none"><a className="nav-link" href="/register">Sign up</a></li>
                                </ul>
                            ...
                            <div className="slider_form row">
                                ...
                                <div className="col-lg-2 col-md-4">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Enter First Name" className="form-control m-b-15" name='fname' value={fname} onChange={(e) => setfname(e.target.value)} />
                                    </div>
                                </div>
                                <div className="col-lg-2 col-md-4">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Enter Last Name" className="form-control m-b-15" name='lname' value={lname} onChange={(e) => setlname(e.target.value)} />
                                    </div>
                                </div>
                                <div className="col-lg-2 col-md-4">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Date of Birth" className="form-control m-b-15" name='dob' value={dob} onChange={(e) => setdob(e.target.value)} />
                                    </div>
                                </div> <div className="col-lg-3 col-md-4">
                                    <div className="form-group">
                                        <select className="form-control show-tick" onChange={(e) => setgender(e.target.value)} name='gender' value={gender}>
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Enter Mobile" className="form-control m-b-15" name='phone' value={phone} onChange={(e) => setphone(e.target.value)} />
                                    </div>
                                </div>

                                <div className="col-lg-2 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Enter Date" className="form-control m-b-15" name='date' value={date} onChange={(e) => setdate(e.target.value)} />
                                    </div>
                                </div>

                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="form-group">
                                        <input type="text" defaultValue placeholder="Enter Email" className="form-control m-b-15" name='email' value={email} onChange={(e) => setemail(e.target.value)} />
                                    </div>
                                </div>
                                <div className="col-lg-2 col-md-6 col-6" name='service' value={service} onChange={(e) => setservice(e.target.value)}>
                                    <select className="form-control ">
                                        {
                                            result.map((i) => {
                                                return (
                                                    <>
                                                        <option selected="selected">{i.fname}</option>
                                                    </>
                                                )
                                            })
                                        }
                                ...
                                <div className="col-lg-2 col-md-6 col-6" name='speciality' value={speciality} onChange={(e) => setspeciality(e.target.value)}>
                                    <select className="form-control">
                                        {
                                            result.map((i) => {
                                                return (
                                                    <>
                                                        <option selected="selected" name='speciality' value={speciality} >{i.speciality}</option>
                                ...
                                <div className="col-lg-2 col-md-6">
                                    <button className="btn btn-primary btn-round btn-block m-t-0 m-b-0" onClick={submit}>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="main-section">
                    ...
                    <div className="about-us-section mt-4">
                        <div className="container">
                            <div className="row">
                                        ...
                                        return (<>
                                            ...
                                            <div className="col-lg-3 col-md-6 col-sm-12">
                                                <div className="team-box text-center" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration={5000}>
                                                    <div className="doctor-pic"><img src={`http://localhost/hospital/img/${i.img}`} alt="Dr. John" /></div>
                                                    <div className="doctor-info">
                                                        <h4>{i.fname}<span>{i.speciality}</span></h4>
